...
from diffusion_policy.policy.noisy_regression_policy import NoisyRegressionPolicy
...
class TrainNoisyRegressionWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: NoisyRegressionPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: NoisyRegressionPolicy = None
...
def main(cfg):
    workspace = TrainNoisyRegressionWorkspace(cfg)
    workspace.run()
