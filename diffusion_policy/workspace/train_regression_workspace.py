...
from diffusion_policy.policy.regression_transformer_timm_policy import RegressionTransformerTimmPolicy
...
class TrainRegressionWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: RegressionTransformerTimmPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: RegressionTransformerTimmPolicy = None
...
def main(cfg):
    workspace = TrainRegressionWorkspace(cfg)
    workspace.run()
